...
##  [/CoffeeCatalog.Client](https://github.com/NetCoreTemplates/blazor-wasm/tree/main/CoffeeCatalog.Client)
...
## [/CoffeeCatalog](https://github.com/NetCoreTemplates/blazor-wasm/tree/main/CoffeeCatalog)

The .NET 6 `/CoffeeCatalog` backend server is required for this App's dynamic functions including the Hello API on the home page
